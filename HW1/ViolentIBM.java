...
k=0;		
	...
	/*for (int y=0; y < totalperfectset; y++)
	{
		System.out.println(perfectset[y]);
	} 
	System.out.println(totalperfectset);
			      
	//10 把perfect 做兩兩比對找子集和

/*for (int f=0; f <totalperfectset ; f++)
{
	System.out.println(perfectset[f]);
			System.out.println(totalperfectset);
}*/
